export default function Footer() {
  ...
  return (
    <footer id="contato" className="bg-gray-900 text-white">
      {/* CTA Section */}
      <div className="py-10 sm:py-16 px-4 sm:px-8 border-b border-gray-800">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <button className="group px-6 sm:px-10 py-3 sm:py-4 bg-primary text-white font-medium rounded-lg hover:bg-primary/90 transition-all duration-300 overflow-hidden text-sm sm:text-base">
            ...
            <button className="group px-6 sm:px-10 py-3 sm:py-4 bg-transparent border border-gray-600 text-white font-medium rounded-lg hover:border-primary hover:text-primary transition-all duration-300 text-sm sm:text-base">
              Avaliação gratuita
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              ...
              <p className="text-gray-500 text-sm mt-2">Brasília, DF - Brasil</p>
            </div>
      ...
      {/* Copyright */}
      <div className="py-4 sm:py-6 px-4 sm:px-8 border-t border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-2 sm:gap-4 text-center">
